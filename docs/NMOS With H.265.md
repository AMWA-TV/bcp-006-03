...
The [Video Services Forum][VSF] developed Technical Recommendation [TR-10-11][TR-10-11] and [TR-10-07][TR-10-07] of the IPMX suite of protocols, which cover the end-to-end application use of constant and variable bit rate compression for video, using the SMPTE ST 2110 and IPMX suite of protocols.

TR-10-11 and TR-10-07 mandate the use of the AMWA [IS-04][IS-04] and [IS-05][IS-05] NMOS Specifications in IPMX compliant systems.
...
[TR-10-11]: https://static.vsf.tv/download/technical_recommendations/VSF_TR-10-11_2024-02-23.pdf "Internet Protocol Media Experience (IPMX):  Constant Bit-Rate Compressed Video"
[TR-10-07]: https://static.vsf.tv/download/technical_recommendations/VSF_TR-10-7_2023-09-26.pdf "Internet Protocol Media Experience (IPMX):  Compressed Video"
